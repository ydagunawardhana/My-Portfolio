  ...
  return (
    <header
      className={mergeClasses(
        'sticky top-0 z-30 w-full border-b border-gray-50 bg-gray max-md:border-gray-100',
        scrolled ? 'bg-gray/50 backdrop-blur-xl md:border-gray-100' : ''
      )}
    >
      <div className="mx-auto flex w-full !max-w-7xl items-center justify-between p-6 md:px-5">
